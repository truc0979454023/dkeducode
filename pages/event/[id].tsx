                  ...
                  <div className="flex flex-col w-full gap-6 ">
                    ...
                    <div className="flex flex-col w-full gap-6">
                      <p className="text-2xl text-center text-yellow-600 font-signika ">
                        HÃY SẴN SÀNG CHINH PHỤC ĐỂ TRỞ THÀNH QUÁN QUÂN MÙA ĐẦU
                        TIÊN CỦA “EXCEL TALENT”
                      </p>
                      <p className="text-2xl text-center text-Slate-900 font-signika">
                        Mời bạn tham gia nhóm ôn luyện kiến thức Excel cùng đội
                        ngũ Giảng viên - Trợ giảng KD Educode
                      </p>
                    </div>
                    <div>
